...
public class ExpressionBuilder {
  ...
  /**
   * Adds either another {@link ExpressionBuilder} or a {@link DCEntity} to the
   * left side of this expression, replacing the previous value if applicable.
   * 
   * @param left The ExpressionBuilder or DCEntity to add.
   * @throws IllegalArgumentException If the object is neither an
   *                                  ExpressionBuilder nor a DCEntity.
   */
  ...
  /**
   * Adds an {@link Operator} to the middle of this expresseion, replacing the
   * previous one if applicable.
   * 
   * @param oper The operator to use.
   */
  ...
  /**
   * Adds either another {@link ExpressionBuilder} or a {@link DCEntity} to the
   * right side of this expression, replacing the previous value if applicable.
   * 
   * @param right The ExpressionBuilder or DCEntity to add.
   * @throws IllegalArgumentException If the object is neither an
   *                                  ExpressionBuilder nor a DCEntity.
   */
  ...
  /**
   * Retrieves the left-side {@link DCEntity}. Returns null if the left side has
   * an {@link ExpressionBuilder} or nothing.
   * 
  ...
  /**
   * Retrieves the right-side {@link DCEntity}. Returns null if the right side has
   * an {@link ExpressionBuilder} or nothing.
   * 
  ...
  /**
   * Retrieves the left-side {@link ExpressionBuilder}. Returns null if the left
   * side has a {@link DCEntity} or nothing.
   * 
  ...
  /**
   * Retrieves the right-side {@link ExpressionBuilder}. Returns null if the right
   * side has a {@link DCEntity} or nothing.
   * 
  ...
  /**
   * Retrieves the current {@link Operator}, or null if one hasn't been assigned
   * yet.
   * 
  ...
  /**
   * Convenience method to return the left-side {@link ExpressionBuilder} or
   * {@link DCEntity}, no matter which it has. Returns null if it has nothing.
   * 
   * @return The left-side ExpressionBuilder or DCEntity, or null if nothing.
   */
  ...
  /**
   * Convenience method to return the right-side {@link ExpressionBuilder} or
   * {@link DCEntity}, no matter which it has. Returns null if it has nothing.
   * 
   * @return The right-side ExpressionBuidler or DCEntity, or null if nothing.
   */
   ...
   * ExpressionBuilder.
   * <p>
   * A {@link BinaryOperator} requires both the left and right to have an object.
   * A {@link PrefixOperator} requires the right to have an object and ignores the
   * left. A {@link PostfixOperator} requires the left to have an object and
   * ignores the right.
   * 
   * @return The operation in question
   * @throws IllegalStateException If it has no operator or no object on the
   *                               correct side(s).
   */
  public DCOperation build() {
    ...
    if (oper == null) {
      throw new IllegalStateException("DCOperations cannot be built without an operator.");
    }
    ...
    if (!(oper instanceof PrefixOperator)) {
      if (leftExp != null) {
        ...
        throw new IllegalStateException(operType + " requires a left-side operand.");
      }
    }
    ...
    if (!(oper instanceof PostfixOperator)) {
      if (rightExp != null) {
        ...
        throw new IllegalStateException(operType + " requires a right-side operand.");
      }
    }
