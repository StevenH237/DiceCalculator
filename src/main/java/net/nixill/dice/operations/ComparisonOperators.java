...
public class ComparisonOperators<T extends DCValue> {
  ...
  public final ComparisonOperator GREATER     = new ComparisonOperator(
      Comparison.GREATER);
  public final ComparisonOperator EQUAL       = new ComparisonOperator(
      Comparison.EQUAL);
  public final ComparisonOperator LESS        = new ComparisonOperator(
      Comparison.LESS);
  public final ComparisonOperator NOT_GREATER = new ComparisonOperator(
      Comparison.NOT_GREATER);
  public final ComparisonOperator NOT_EQUAL   = new ComparisonOperator(
      Comparison.NOT_EQUAL);
  public final ComparisonOperator NOT_LESS    = new ComparisonOperator(
      Comparison.NOT_LESS);
  ...
  public static boolean compares(double left, Comparison comp,
      double right) {
