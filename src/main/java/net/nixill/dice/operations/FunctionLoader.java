...
public abstract class FunctionLoader {
   ...
   * 
   * @param name
   *   The name of the variable, with its <code>_</code> prefix removed.
   */
   ...
   * 
   * @param name
   *   The name of the variable, with its <code>$</code> prefix removed.
   */
   ...
   *   The name of the variable.
   * @param ent
   *   The entity to store in the variable.
   */
   ...
   *   The name of the variable.
   * @param result
   *   The result to store in that variable.
   */
